...
//        _tableView.frame = CGRectMake(0, SafeAreaTopHeight, ScreenW, SafeAreaHeightWithBottom);
...
//        _bgTipButton.titleLabel.font = AppFont(13);
...
//    _tableView.frame = CGRectMake(0, SafeAreaTopHeight, ScreenW, SafeAreaHeightWithBottom);
    ...
    [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([DCUserAdressCell class]) bundle:nil] forCellReuseIdentifier:DCUserAdressCellID];
...
{
    CGFloat hight = _adItem[indexPath.row].cellHeight;
    return hight;
