...
@interface orderSelectVC () <UITableViewDelegate, UITableViewDataSource>
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell setCellContent:@"address" labContent:[NSString stringWithFormat:@"第%ld行", row]];
    return cell;
}
