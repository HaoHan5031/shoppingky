...
- (void)loadView {
    ...
    mainWebView.backgroundColor = [UIColor colorWithRed:239/255.0 green:239/255.0 blue:244/255.0 alpha:1];
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *leftItem = [[UIBarButtonItem alloc]initWithTitle:@"" style:UIBarButtonItemStylePlain target:self action:@selector(backToHomePage:)];
    self.navigationItem.leftBarButtonItem = leftItem;
}

-(void)backToHomePage:(UIBarButtonItem *)item{
...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
   ...
   // self.navigationItem.title = [webView stringByEvaluatingJavaScriptFromString:@"document.title"];
    ...
    NSString *script = [NSString stringWithFormat: @"var script = document.createElement('script');"
                        ...
                        "}"
                        "}\";"
                        "document.getElementsByTagName('p')[0].appendChild(script);",(int)mainWebView.bounds.size.width];
    
    
    [webView stringByEvaluatingJavaScriptFromString:script];
    [webView stringByEvaluatingJavaScriptFromString:@"document.body.style.webkitTouchCallout='none';document.bbodystyle.KhtmlUserSelect-'none'"];
